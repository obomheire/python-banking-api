...
Revision ID: cfb125022096
Revises: 1ff4de1bbaf9
Create Date: 2025-05-09 11:57:37.623728
...
revision: str = "cfb125022096"
down_revision: Union[str, None] = "1ff4de1bbaf9"
...
def upgrade() -> None:
    ...
    op.create_table(
        "profile",
        sa.Column(
            "title", sa.Enum("Mr", "Mrs", "Miss", name="salutationenum"), nullable=False
        ),
        sa.Column(
            "gender",
